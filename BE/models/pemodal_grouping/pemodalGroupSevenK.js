...
const SchemaPeminjamGroupSevenK = new Schema({
...
const PeminjamGroupSevenK = mongoose.model('PeminjamGroupSevenK', SchemaPeminjamGroupSevenK);

module.exports = PeminjamGroupSevenK;
