...
const SchemaPeminjamGroupThreeK = new Schema({
...
const PeminjamGroupThreeK = mongoose.model('PeminjamGroupThreeK', SchemaPeminjamGroupThreeK);

module.exports = PeminjamGroupThreeK;
