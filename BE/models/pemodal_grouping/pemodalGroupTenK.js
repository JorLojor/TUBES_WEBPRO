...
const SchemaPeminjamGroupTenK = new Schema({
...
const PeminjamGroupTenK = mongoose.model('PeminjamGroupTenK', SchemaPeminjamGroupTenK);

module.exports = PeminjamGroupTenK;
