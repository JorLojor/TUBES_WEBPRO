...
const SchemaPeminjamGroupOneK = new Schema({
...
const PeminjamGroupOneK = mongoose.model('PeminjamGroupOneK', SchemaPeminjamGroupOneK);

module.exports = PeminjamGroupOneK;
