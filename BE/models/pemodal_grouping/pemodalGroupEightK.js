...
const SchemaPeminjamGroupEightK = new Schema({
...
const PeminjamGroupEightK = mongoose.model('PeminjamGroupEightK', SchemaPeminjamGroupEightK);

module.exports = PeminjamGroupEightK;
